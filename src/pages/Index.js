  ...
  >
    <article className="post" id="index">
      ...
      <p>
        ...
        An <a href="https://www.iitb.ac.in/">IIT Bombay</a> and <a href="https://www.wqu.org/">WQU</a> graduate, I currently work as an SWE in <a href="https://www.google.com/">Google</a>.<br />Feel free to check out my {' '}<Link to="/resume">resume</Link>, {' '}<Link to="/projects">projects</Link>, {' '}view <Link to="/stats">site statistics</Link>, {' '}or <Link to="/contact">contact</Link> me.<br />I also maintain a TiddlyWiki named <a href="https://0neir0s.github.io/kladde" target="_blank" rel="noreferrer">Kladde</a>.
      </p>
    </article>
  </Main>
);
